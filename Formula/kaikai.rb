class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.60.0/kaikai-v0.60.0-darwin-arm64.tar.gz"
      sha256 "0d84f17998bef84471f7ba0e650b28b82dfa9218be1d229120ecf1fb4ab18f67"
    end
  end
