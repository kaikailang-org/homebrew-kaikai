class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.108.0/kaikai-v0.108.0-darwin-arm64.tar.gz"
      sha256 "98f3391e7c4a4a4eca7ba9b15220b0324235ce2f68b35bcd44ef20dac4dcc0be"
    end
  end
