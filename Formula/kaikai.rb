class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.57.1/kaikai-v0.57.1-darwin-arm64.tar.gz"
      sha256 "a156bbbdf115cf4328059140ff4e118815fbd304f439b5e4819dcb4e8bced48e"
    end
  end
