class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.121.0/kaikai-v0.121.0-darwin-arm64.tar.gz"
      sha256 "53acc689cda7ab67764b08833604087220db06ac28e07610163539c61deff8b3"
    end
  end
