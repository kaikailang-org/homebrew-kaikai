class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.107.0/kaikai-v0.107.0-darwin-arm64.tar.gz"
      sha256 "e93136f628d14acccdc7cf9c8f94ad8e9d4eec57807cd1d99090a7396e2fcc3a"
    end
  end
