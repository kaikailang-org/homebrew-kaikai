class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.109.1/kaikai-v0.109.1-darwin-arm64.tar.gz"
      sha256 "e209d2e8f0f4f8dcf37f7088053867ca500e909aed4b6d2b30c8d52427fa97c5"
    end
  end
