class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.71.0/kaikai-v0.71.0-darwin-arm64.tar.gz"
      sha256 "2bec03bd15034883c0a908d63f5bef8ed7827d54869234a059625b3cdfa3d080"
    end
  end
