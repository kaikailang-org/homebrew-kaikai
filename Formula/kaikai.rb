class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.123.0/kaikai-v0.123.0-darwin-arm64.tar.gz"
      sha256 "56d2f6f0fead2b2532bf5da02852cfc58031bb1a80a2c28222278341850a97df"
    end
  end
