class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.109.0/kaikai-v0.109.0-darwin-arm64.tar.gz"
      sha256 "cb448fb2e61547f34a9b0a51eaf899fb934477480ba6bdf19352269522fe7cc1"
    end
  end
