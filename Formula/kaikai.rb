class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.72.1/kaikai-v0.72.1-darwin-arm64.tar.gz"
      sha256 "4da3652ad48aea06b7c8719506394184cbe43bfbf62285fbbb5263318d9c8b55"
    end
  end
