class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.1/kaikai-v0.99.1-darwin-arm64.tar.gz"
      sha256 "119e0d9e10b69f41f08c679d42091742d93b7179d9ea6c7c73a8879457b39ee2"
    end
  end
