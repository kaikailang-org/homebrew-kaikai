class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.10/kaikai-v0.99.10-darwin-arm64.tar.gz"
      sha256 "45d6acabfac7684fa058e3d9522b022c4a6476611636391a016a3e0b3b2078a0"
    end
  end
