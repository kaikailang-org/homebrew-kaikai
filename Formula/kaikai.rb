class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.104.0/kaikai-v0.104.0-darwin-arm64.tar.gz"
      sha256 "078f2a2693aaf81def35b740f6b14b7670beb1fd7e4a922a27b1e5d190a9541c"
    end
  end
