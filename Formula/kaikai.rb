class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.91.1/kaikai-v0.91.1-darwin-arm64.tar.gz"
      sha256 "0e508a5067efe348a89294c4b79d6e97736f160e95a826e4f058598cc30fdedc"
    end
  end
