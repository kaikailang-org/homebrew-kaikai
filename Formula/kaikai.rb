class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.114.0/kaikai-v0.114.0-darwin-arm64.tar.gz"
      sha256 "535f1bbb991e3cff7d48f31903103ef5dd260350688737709c4985a5cc3ae081"
    end
  end
