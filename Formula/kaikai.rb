class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.75.1/kaikai-v0.75.1-darwin-arm64.tar.gz"
      sha256 "5b67a1667169fd3fa310e1e99ff852db5b6f4add466684218ce3ff46454be8bc"
    end
  end
