class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.76.1/kaikai-v0.76.1-darwin-arm64.tar.gz"
      sha256 "af730662383d04165b205193d0752048aa1b139f9f63affc923d8a66fbd091a9"
    end
  end
