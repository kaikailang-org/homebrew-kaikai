class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.64.0/kaikai-v0.64.0-darwin-arm64.tar.gz"
      sha256 "c668187db1238713f95f1c8cb283450e39ad1996978496b1b38e37ed0765810f"
    end
  end
