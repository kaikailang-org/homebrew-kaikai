class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.4/kaikai-v0.99.4-darwin-arm64.tar.gz"
      sha256 "e1d1bbb9f02ed73112fa18d8ab611b9769735f1e599260db5bb69053dbc4cd63"
    end
  end
