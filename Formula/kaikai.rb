class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.80.0/kaikai-v0.80.0-darwin-arm64.tar.gz"
      sha256 "270d9e433f0e18ad5140f04b45783c55e0cf8a6fc1c565d5b589f467a40234b0"
    end
  end
