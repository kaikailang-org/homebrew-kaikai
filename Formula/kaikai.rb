class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.78.0/kaikai-v0.78.0-darwin-arm64.tar.gz"
      sha256 "14749ee593dec2285763298762d18e5bbcf9f9d03eae66b557084ae55832b353"
    end
  end
