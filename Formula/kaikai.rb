class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.112.0/kaikai-v0.112.0-darwin-arm64.tar.gz"
      sha256 "fa02549533235ce84b2095c310980a15eaa3eaff38517b53499ffe854b19d3c0"
    end
  end
