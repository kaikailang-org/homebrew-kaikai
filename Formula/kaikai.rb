class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.110.0/kaikai-v0.110.0-darwin-arm64.tar.gz"
      sha256 "160aa0f72e8b47abd33638835b163df1fcc00712b9517d437e99253500543209"
    end
  end
