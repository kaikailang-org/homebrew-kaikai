class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.88.0/kaikai-v0.88.0-darwin-arm64.tar.gz"
      sha256 "ad9e5fd7a686779c83d15a4c5fd25a499b8d406e7c18ae8f559adb6828db567b"
    end
  end
