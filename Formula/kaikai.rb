class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.124.1/kaikai-v0.124.1-darwin-arm64.tar.gz"
      sha256 "b39671521eab73d1de21e2b8611826787470b25d8b281c9077e7903591b69261"
    end
  end
