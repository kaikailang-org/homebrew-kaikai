class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.66.0/kaikai-v0.66.0-darwin-arm64.tar.gz"
      sha256 "67ef2a916da978ce12bb9b9e9e76aff8eae792082399f00a9082543e04c77c11"
    end
  end
