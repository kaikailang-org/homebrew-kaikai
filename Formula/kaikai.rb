class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.109.2/kaikai-v0.109.2-darwin-arm64.tar.gz"
      sha256 "d01642010f991f0c8a3fed8b0601ea1e82363ed116e2f373a22d984cc7157d38"
    end
  end
