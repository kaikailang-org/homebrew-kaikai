class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.124.0/kaikai-v0.124.0-darwin-arm64.tar.gz"
      sha256 "5a905f34dbc7d76c99b3c613bf56961d78aaa76cc83b8e820a3945b2a98f7252"
    end
  end
