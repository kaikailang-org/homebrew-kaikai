class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.74.0/kaikai-v0.74.0-darwin-arm64.tar.gz"
      sha256 "f8208c42cd42c41c54e950fa49792a2fabdd78c8f2e8c5d9b70ccc2fcb530c1a"
    end
  end
