class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.122.0/kaikai-v0.122.0-darwin-arm64.tar.gz"
      sha256 "e638a1fe5963972f3c02d786993328b389c979f51e0d31614673c3af1a416188"
    end
  end
