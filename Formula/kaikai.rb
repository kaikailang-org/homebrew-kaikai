class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.55.0/kaikai-v0.55.0-darwin-arm64.tar.gz"
      sha256 "ce0bb7f04377c3f61d3c147ff8a2fc566b2bbebde9c9de47f139b40b595057c1"
    end
  end
