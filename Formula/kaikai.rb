class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.82.0/kaikai-v0.82.0-darwin-arm64.tar.gz"
      sha256 "1cb1432dbe9006540782094b4f2cb1b6ff419883ee3d9bc7221bf588516259d0"
    end
  end
