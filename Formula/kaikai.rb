class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.92.0/kaikai-v0.92.0-darwin-arm64.tar.gz"
      sha256 "86cb86658c67a624da7c562841a625c0c48681f28874f9915b2d4237d215c5ae"
    end
  end
