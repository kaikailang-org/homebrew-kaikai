class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.14/kaikai-v0.99.14-darwin-arm64.tar.gz"
      sha256 "2f7c7e23ce92da3b9a442a910666cdf1a9f9552ddbc103cc5173db6bca28f8f8"
    end
  end
