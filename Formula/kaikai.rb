class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.75.0/kaikai-v0.75.0-darwin-arm64.tar.gz"
      sha256 "0c6c50ed98ef849fa1a44efcfaf9522620b82cfd10cb79a5786d91271d8288b6"
    end
  end
