class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.6/kaikai-v0.99.6-darwin-arm64.tar.gz"
      sha256 "4182abf6ca8b7d00109791811ea63baceed9d45cbe03b2a3ad586d3323453c8d"
    end
  end
