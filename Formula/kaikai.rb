class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.77.0/kaikai-v0.77.0-darwin-arm64.tar.gz"
      sha256 "96eb806e7839c84c975ef8b2ee7d9e0adf0f71e85fb5a2d6452734dcc676a640"
    end
  end
