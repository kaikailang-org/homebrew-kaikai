class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.105.1/kaikai-v0.105.1-darwin-arm64.tar.gz"
      sha256 "8fc2a237a2981adaa6ec9d4d5f310f11d367a81296381be6b65c422d17d27292"
    end
  end
