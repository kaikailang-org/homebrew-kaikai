class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.93.0/kaikai-v0.93.0-darwin-arm64.tar.gz"
      sha256 "0b7e9d708cba7617b2628a193404358da9f35a0e4b01c4700062924c7273df2d"
    end
  end
