class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.70.0/kaikai-v0.70.0-darwin-arm64.tar.gz"
      sha256 "2bb4354019c4307dc68170f9195928142fcd7093b82a28f86c70053673bfc579"
    end
  end
