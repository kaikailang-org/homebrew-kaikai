class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.15/kaikai-v0.99.15-darwin-arm64.tar.gz"
      sha256 "8df5c10bb999295d3cffe230bca08a40ec5461ccd7585c808f20b2df1e84c788"
    end
  end
