class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.57.0/kaikai-v0.57.0-darwin-arm64.tar.gz"
      sha256 "3dbdc2d7153d77e5bd2b127a9b4fbe25a28eb8a6986eb547496f387fd487f469"
    end
  end
