class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.8/kaikai-v0.99.8-darwin-arm64.tar.gz"
      sha256 "ebaf24f5a65abff733e0447d3266c09fedb16b5f6d1a5c499dc72a21411f5276"
    end
  end
