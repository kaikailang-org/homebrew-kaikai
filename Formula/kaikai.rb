class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.91.3/kaikai-v0.91.3-darwin-arm64.tar.gz"
      sha256 "3b7f9960719ffc10ce02b15afdb4bfba9c61b32e0d142c393e0ee84d1a6a88e2"
    end
  end
