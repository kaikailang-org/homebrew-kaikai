class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.13/kaikai-v0.99.13-darwin-arm64.tar.gz"
      sha256 "cd883d4fd8e2237fc8466562da6939b9edd4f810edf0d0880ee36d84595ab243"
    end
  end
