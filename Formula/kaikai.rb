class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.96.0/kaikai-v0.96.0-darwin-arm64.tar.gz"
      sha256 "ad9ef9d89da1831763bca913945fe90188d07871bbdba61bf1128b7787c06a63"
    end
  end
