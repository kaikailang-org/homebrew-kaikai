class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.56.1/kaikai-v0.56.1-darwin-arm64.tar.gz"
      sha256 "b454ba4b21aa9b6edcf38438b3c53e263e485f1e6f7dc9a4032553000edd12a2"
    end
  end
