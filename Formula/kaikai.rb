class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.115.0/kaikai-v0.115.0-darwin-arm64.tar.gz"
      sha256 "d247a0a8b2eb52f8a26680cf9f7cd98fa97dd6f1ded8336b560b1a8829b89496"
    end
  end
