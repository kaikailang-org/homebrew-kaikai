class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.89.0/kaikai-v0.89.0-darwin-arm64.tar.gz"
      sha256 "9661c2faa1f4d9882c3fe8b12b150bd1932edb11c66ad276aa4db9b9581f6c8c"
    end
  end
