class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.103.0/kaikai-v0.103.0-darwin-arm64.tar.gz"
      sha256 "22469fdc1dece240938e0a8e135a16b0cd18fee691236b3f3a4770eca01d5f55"
    end
  end
