class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.83.3/kaikai-v0.83.3-darwin-arm64.tar.gz"
      sha256 "912a6c99b4ac4bdb6a2a4c8eeab2a5d0f6ed5bc6ed14f5405b40f7c019698f76"
    end
  end
