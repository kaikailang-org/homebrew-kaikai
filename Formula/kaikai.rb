class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.56.0/kaikai-v0.56.0-darwin-arm64.tar.gz"
      sha256 "bee1656638fbf619593b01acb090bf0316d4f934d76a63317d406b641aa916ad"
    end
  end
