class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.72.0/kaikai-v0.72.0-darwin-arm64.tar.gz"
      sha256 "f4cf93468bbe9f624fcc19470cecba2ee24bcce83662336552e82cb92eb57243"
    end
  end
