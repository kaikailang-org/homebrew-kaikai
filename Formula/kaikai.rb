class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.81.0/kaikai-v0.81.0-darwin-arm64.tar.gz"
      sha256 "3416620c322086a39a04242d67759695f73ae6bb353e9958f37aafdce05ede1a"
    end
  end
