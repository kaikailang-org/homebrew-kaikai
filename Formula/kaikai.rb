class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.7/kaikai-v0.99.7-darwin-arm64.tar.gz"
      sha256 "96cc3d70ff6676bd64edad19897abc8feb464fbaa8fbf167f30fefcb44f3c575"
    end
  end
