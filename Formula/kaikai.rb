class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.118.0/kaikai-v0.118.0-darwin-arm64.tar.gz"
      sha256 "52a93e4a33601900cb311d11aeab01cb76666c1b486ce5e42c5ac364061f1de9"
    end
  end
