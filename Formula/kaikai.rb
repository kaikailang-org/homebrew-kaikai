class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.56.3/kaikai-v0.56.3-darwin-arm64.tar.gz"
      sha256 "039ae5d71961ab1c566472bafcf7c56dfaa01e703c54d0bfd7971631ec98ad36"
    end
  end
