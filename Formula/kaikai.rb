class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.74.1/kaikai-v0.74.1-darwin-arm64.tar.gz"
      sha256 "cee69a0c620efc8dd532ca1b0dcb1074b1ec641946afeb05d1748600c00d816a"
    end
  end
