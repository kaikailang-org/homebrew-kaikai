class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.108.1/kaikai-v0.108.1-darwin-arm64.tar.gz"
      sha256 "be71e22a9b102512730fe38fb2d6446e224832edf75b1185a96da34d57bd0c46"
    end
  end
