class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.74.2/kaikai-v0.74.2-darwin-arm64.tar.gz"
      sha256 "78f27cdc0c12176a9b51ab551cc265ff7dec2ae10da9cd17fe62815966fddbbc"
    end
  end
