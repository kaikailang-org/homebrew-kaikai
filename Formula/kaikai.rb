class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.0/kaikai-v0.99.0-darwin-arm64.tar.gz"
      sha256 "d494ce19ecc8e0989c0416b2e3fb8492d66aeb65b1aad21b08aae2119308bb0c"
    end
  end
