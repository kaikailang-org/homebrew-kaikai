class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.116.0/kaikai-v0.116.0-darwin-arm64.tar.gz"
      sha256 "34a5fa2ffad1214f4ce74a4e538ef82e561cda3b9f6459c7b366826689420f8d"
    end
  end
