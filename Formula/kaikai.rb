class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.96.1/kaikai-v0.96.1-darwin-arm64.tar.gz"
      sha256 "a259e7fd0b0cc2c78a5df7cbe040138e5c086a256fcb281e62ed90accb1ea75e"
    end
  end
