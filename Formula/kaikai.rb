class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.2/kaikai-v0.99.2-darwin-arm64.tar.gz"
      sha256 "f10a135076ae09eab9557e151e82af49479b6051e5c71ef19ab6e8267fac9f5e"
    end
  end
