class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.76.0/kaikai-v0.76.0-darwin-arm64.tar.gz"
      sha256 "3c8c1037dc69e520b69035fdd2b90c0d04400cf190ccdb5f0e3e5c6941b810f5"
    end
  end
