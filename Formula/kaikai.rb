class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.11/kaikai-v0.99.11-darwin-arm64.tar.gz"
      sha256 "40829060f49c035415e427b8cd9b5a34ce42fe7a85b6ea4b385feaf41149a113"
    end
  end
