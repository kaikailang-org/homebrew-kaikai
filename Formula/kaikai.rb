class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.119.0/kaikai-v0.119.0-darwin-arm64.tar.gz"
      sha256 "a864abe632e89afdf98870049a4af8151a02ed0e4731fd8ca7a3336b4fb5f6a0"
    end
  end
