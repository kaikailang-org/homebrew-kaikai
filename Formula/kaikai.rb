class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.91.2/kaikai-v0.91.2-darwin-arm64.tar.gz"
      sha256 "d215092a05ec8c823491530f24d507a8c84325d09a38ba5722fcacb779d1a2be"
    end
  end
