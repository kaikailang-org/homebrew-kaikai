class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.100.0/kaikai-v0.100.0-darwin-arm64.tar.gz"
      sha256 "f639958d17d123ab7e01e42cbbd388a5203f8c1492dccecad3e0247ba4ec9713"
    end
  end
