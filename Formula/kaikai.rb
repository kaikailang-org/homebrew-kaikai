class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.59.0/kaikai-v0.59.0-darwin-arm64.tar.gz"
      sha256 "fe7e686c422f48798ab3dc4703fbd84ac2f15124f307791232dcfb531f6d5e48"
    end
  end
