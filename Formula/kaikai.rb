class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.105.0/kaikai-v0.105.0-darwin-arm64.tar.gz"
      sha256 "2073d7922cfcc610fc3e1067c3401398f8ce4e80b48b31d5bf3b032dff61dc66"
    end
  end
