class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.90.0/kaikai-v0.90.0-darwin-arm64.tar.gz"
      sha256 "976c96d075c74bf2f49e085d721e083fc02094a08ed2d1e8c58762255eb77b8d"
    end
  end
