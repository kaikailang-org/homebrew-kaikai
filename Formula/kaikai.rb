class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.97.0/kaikai-v0.97.0-darwin-arm64.tar.gz"
      sha256 "c4d9ed70bb455981fd236911857a0047690c57c307c156a7e980b444805f9c35"
    end
  end
