class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.84.0/kaikai-v0.84.0-darwin-arm64.tar.gz"
      sha256 "538d4b941d2bd44d9710965e24791e06f4e33b000168bd9d42a76da1afd8117e"
    end
  end
