class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.63.1/kaikai-v0.63.1-darwin-arm64.tar.gz"
      sha256 "c61a00b94d7e4a53b8e65554d78376a2f3bdaeef8993dae562590b5bd2d6dcdd"
    end
  end
