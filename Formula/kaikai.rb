class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.67.0/kaikai-v0.67.0-darwin-arm64.tar.gz"
      sha256 "8038409658cb06e7105cd62bf800ade590a269654b820b405b20d96e8b9514a7"
    end
  end
