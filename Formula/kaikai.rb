class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.69.0/kaikai-v0.69.0-darwin-arm64.tar.gz"
      sha256 "e980fb645c0235f4a57c30f466a311a88fd4929b8566e263ae6d6d9b9d0b63a7"
    end
  end
