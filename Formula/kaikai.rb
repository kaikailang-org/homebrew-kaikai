class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.95.0/kaikai-v0.95.0-darwin-arm64.tar.gz"
      sha256 "194af33108ce8efaae42b7d1f8bdadf00b990f0c36037abe55e65feaf11020e0"
    end
  end
