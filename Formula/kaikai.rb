class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.108.2/kaikai-v0.108.2-darwin-arm64.tar.gz"
      sha256 "d4232df681d68c12b1c327a180bdfc083cba3e8e5d8091dbe22f981d54c92f4e"
    end
  end
