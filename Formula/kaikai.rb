class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.94.0/kaikai-v0.94.0-darwin-arm64.tar.gz"
      sha256 "893be5d19c73bb6a76365170b77d7b4166930cea5b553723bfdca6a07c8d4569"
    end
  end
