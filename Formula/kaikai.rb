class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.58.0/kaikai-v0.58.0-darwin-arm64.tar.gz"
      sha256 "2d939e029744883d06a1ef6bc4fda6c6aed2bbe7d47ed80161c21736fa5563bd"
    end
  end
