class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.12/kaikai-v0.99.12-darwin-arm64.tar.gz"
      sha256 "1b4a3768e32d5fb06ce786b0b8b8ed6d71298022aad2dbb58e36fe8743314da5"
    end
  end
