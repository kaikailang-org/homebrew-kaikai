class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.112.1/kaikai-v0.112.1-darwin-arm64.tar.gz"
      sha256 "6f82311a692db160644d4a6863a9df68bc7ef1fac5fcbb94e3918cd969e448d1"
    end
  end
