class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.3/kaikai-v0.99.3-darwin-arm64.tar.gz"
      sha256 "419b81d019108156cf2357b67735742a27fb2a61d7ae3bb2c9e6736edf806d3b"
    end
  end
