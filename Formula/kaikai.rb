class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.73.0/kaikai-v0.73.0-darwin-arm64.tar.gz"
      sha256 "d03c10eaa75a286ec051b7dfec409d1ab7c8d216aae26c9bb26fd269989bd27c"
    end
  end
