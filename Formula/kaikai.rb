class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.111.0/kaikai-v0.111.0-darwin-arm64.tar.gz"
      sha256 "c5ee62044f0c1fdb52f923c04e7a22d20fcc39a2dd8331cc940c8d4968845ce3"
    end
  end
