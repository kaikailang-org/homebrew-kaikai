class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.120.0/kaikai-v0.120.0-darwin-arm64.tar.gz"
      sha256 "f9dfa1ac2e6d042ade09d0ff6c77010a246911f21b22efd346c891f730b20250"
    end
  end
