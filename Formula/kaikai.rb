class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.18/kaikai-v0.99.18-darwin-arm64.tar.gz"
      sha256 "84e8e4e0a285221d7794bd8fdb9ca42f20c3d5158dde5b395e7c2d859d5de14f"
    end
  end
