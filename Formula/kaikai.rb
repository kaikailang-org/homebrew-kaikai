class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.77.1/kaikai-v0.77.1-darwin-arm64.tar.gz"
      sha256 "60ee44018334f04fef7d902f5db1eaa88dd97c07f15c272551868fa7398efd80"
    end
  end
