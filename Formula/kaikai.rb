class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.5/kaikai-v0.99.5-darwin-arm64.tar.gz"
      sha256 "5f217e32205d9e20fe6297c1ab8097c4cff69c92362da3711b12978278fc9b8a"
    end
  end
