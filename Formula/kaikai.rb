class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.56.2/kaikai-v0.56.2-darwin-arm64.tar.gz"
      sha256 "e37920eb3813e8d1200001125bcdfb3cb1e02ecaba1a5c69ed89379fb521d786"
    end
  end
