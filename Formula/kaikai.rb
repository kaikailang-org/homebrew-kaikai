class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.61.0/kaikai-v0.61.0-darwin-arm64.tar.gz"
      sha256 "0493e44235511b773b4ce58119eb565583ed233fa9db8713c068aeef266f58ab"
    end
  end
