class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.58.1/kaikai-v0.58.1-darwin-arm64.tar.gz"
      sha256 "d27085cdf9623bde11ced4ab35fa7c490d14f74d6fb7b4b58c031a8eb03d7542"
    end
  end
