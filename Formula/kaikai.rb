class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.99.19/kaikai-v0.99.19-darwin-arm64.tar.gz"
      sha256 "33892173cdb4a3a0b2e6b8b690b041ebd523be7c5c5ce00e36a33820982fe62f"
    end
  end
