class Kaikai < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kaikailang-org/kaikai/releases/download/v0.86.1/kaikai-v0.86.1-darwin-arm64.tar.gz"
      sha256 "47f09b9f02ac9f3d4a55b7fb4f89064509c1b1fa911096757e5e589cc0c95e1c"
    end
  end
